...
Revamped Version of an Online Module Project (DS / ML Final Project)
...
• Python: Data cleaning, statistical analysis, and machine learning modeling.

• PostgreSQL: Database management for large-scale datasets.

• Plotly: State-of-the-art visualizations for both static and interactive graphics.
...
• Analytics & Basic ML: Employing foundational machine learning for trend predictions and policy simulation.
...
When combined, these projects form a cohesive exploration of the initiatives shaping global trade, specifically for China, West Africa, and third-party stakeholders.
